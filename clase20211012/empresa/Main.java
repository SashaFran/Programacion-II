...
public class Main {
    public static void main(String[] args) {
        ...
        ArrayList<Empleado> empJava = empresa.empleadosCon("Java", cSueldoInv);
        ...
        ArrayList<Empleado> empJava2 = empresa.empleadosCon("Java", apellidoNombreSueldo);
